...
const FROM = process.env.EMAIL_FROM || 'MeetingPrep Pro - AI meeting preparation automation <noreply@example.com>';
const APP_NAME = 'MeetingPrep Pro - AI meeting preparation automation';
